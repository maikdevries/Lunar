...
async function execute (client, newPresence) {
	...
	if (!guildSettings.enabled || !await checkGuildPermissions(client, newPresence.guild, [PermissionFlagsBits.ManageRoles]) || !await checkRolePosition(client, newPresence.guild, guildSettings.shoutoutRole)) return;
